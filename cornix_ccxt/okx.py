...
class okx(Exchange):
            ...
            'api': {
                'public': {
                    'get': [
                        ...
                        'public/vip-interest-rate-loan-quota',
                        ...
                        'system/status',
                        'asset/lending-rate-summary',
                        'asset/lending-rate-history',
                ...
                'private': {
                    'get': [
                        ...
                        'asset/lending-history',
                        'asset/saving-balance',
                        'trade/order',
                        ...
                        'finance/staking-defi/orders-active',
                        'finance/staking-defi/orders-history',
                    ],
                    'post': [
                        ...
                        'asset/set-lending-rate',
                        'asset/cancel-withdrawal',
                        'asset/convert-dust-assets',
                        'trade/order',
                        'trade/batch-orders',
                        'trade/cancel-order',
                        ...
                        'asset/subaccount/set-transfer-out',
                        # broker
                        'broker/nd/create-subaccount',
                        'broker/nd/delete-subaccount',
                        'broker/nd/set-subaccount-level',
                        'broker/nd/set-subaccount-fee-rate',
                        'asset/broker/nd/subaccount-deposit-address',
                        'broker/nd/subaccount/apikey',
                        'broker/nd/subaccount/delete-apikey',
    ...
    def parse_trading_balance(self, response):
        ...
        for i in range(0, len(details)):
            ...
            if (eq is None or eq == '') or (availEq is None or availEq == ''):
