...
class ftx(Exchange):
    ...
    def fetch_balance(self, params={}):
        ...
        for i in range(0, len(balances)):
            ...
            account['free'] = self.safe_float_2(balance, 'availableWithoutBorrow', 'free')
    ...
    def fetch_collateral(self, params={}):
        ...
        free_collateral = self.safe_float(result, 'freeCollateral')
        return {"free_collateral": free_collateral, "collateral": collateral}
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'private':
            ...
            if self.partner_name:
                query["externalReferralProgram"] = self.partner_name
