...
class binance(Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(binance, self).describe(), {
            ...
            'exceptions': {
                ...
                '-4161': ExchangeError,  # Leverage reduction is not supported in Isolated Margin Mode with open positions.
            },
        })
    ...
    def handle_isolated_leverage(self, response):
        results = dict()
        for symbol_data in response:
            symbol = self.safe_string(symbol_data, "symbol")
    ...
    def _get_leverage_limits(self):
        ...
        if _type == "future":
            ...
            results = self.handle_isolated_leverage(isolated_response)
    ...
    def get_pnl_history(self):
        ...
        if _type == "future":
            ...
            pnl_history = self.dapiPrivateGetIncome({"incomeType": "REALIZED_PNL"})
        else:
            raise NotSupported()
    ...
    def set_leverage(self, symbol, leverage):
        ...
        if type == "future":
            ...
            return self.dapiPrivate_post_leverage({"symbol": _id, "leverage": int(float(leverage))})
        else:
            raise NotSupported()
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        if self.broker_id:
            params["newClientOrderId"] = "x-%s%s" % (self.broker_id, (str(uuid4()).replace("-", ""))[:16])
        response = getattr(self, method)(self.extend(request, params))
